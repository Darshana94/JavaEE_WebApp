<%-- 
    ...
    Created on : Jul 23, 2018, 6:55:10 PM
    Author     : Home
--%>
                                    ...
                                    <%
                                        ...
                                        if(userClaims.isEmpty()){
                                            ...
                                            for(int i=0;i<userClaims.size();i++){
                                                ...
                                                else if(claim.getStatus() == "ACCEPTED"){out.println("<tr class=\"success\">");break;}
                                                else if(claim.getStatus() == "REJECTED"){out.println("<tr class=\"danger\">");break;}
                                                else {out.println("<tr class=\"active text-muted\">");}
                            ...
                            <table class="table" >
                                ...
                                <%
                                    ...
                                    if(user==null){
                                        ...
                                        out.println("<center><img src=\"/Web_App/assets/user_icon.png\" width=\"100px\"></center>");
                                        out.println("</td>");
                                        out.println("<td class=\"col-md-7\">");
                                        
                                        if(user.isUserValid() == "APPLIED"){
                                            out.println("<h5><span class=\"label label-warning\">APPLIED</span></h5>");
                                        }
                                        else if(user.isUserValid() == "APPROVED"){
                                         out.println("<h5><span class=\"label label-success\">APPROVED</span></h5>");
                                        }
                                        else if(user.isUserValid() == "SUSPENDED"){
                                            out.println("<h5><span class=\"label label-danger\">SUSPENDED</span></h5>");
                                        }
                                        else if(user.isUserValid() == "DELETED") {
                                            out.println("<h5><span class=\"label label-default\">DELETED</span></h5>");
                                        }
