<%-- 
    ...
    Created on : Jul 23, 2018, 6:50:40 PM
    Author     : Home
--%>
...
<% List paymentlist = (ArrayList)session.getAttribute("paymentlist"); %>
<% List claimlist = (ArrayList)session.getAttribute("claimlist"); %>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="container">
            ...
            <div class="col-md-3 text-center">
                <img src="/Web_App/assets/user_icon.png" height="150px">
